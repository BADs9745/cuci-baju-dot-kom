						...
						{paketList.map(({ id, name, description, pricePerUnit }, i) => (
							<label className="group" key={id}>
								<input
									...
									className="hidden"
								/>
								<div className="flex flex-col bg-primary group-has-checked:bg-primary group-has-checked:border-2 border-green-500 dark:border-green-900 rounded-md p-5 h-full relative *:z-10 duration-500 transition-colors **:duration-500 **:transition-colors group-has-checked:text-slate-50 text-stone-950">
